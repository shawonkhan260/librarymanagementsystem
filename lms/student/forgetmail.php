...
$row=mysqli_fetch_array($d);
        if ($row > 0) {
	        ...
	        $q="UPDATE student_reg SET token='$token', 
...
$mail = new PHPMailer();
  ...
  $mail->Subject = "reset password";
  	        $mail->Body = "
	            ...
	            <a href='http://localhost/librarymanagement/student/forgetupdate.php?token=$token'><h2>click here</h2></a><br><br>
